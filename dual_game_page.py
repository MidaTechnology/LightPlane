...
class DualGamePage:
    ...
    def __update_sprites(self):
        ...
        if self.button.pause_game % 2 != 0:
            # 绘制所有精灵组
            for group in [self.back_group, self.hero_group1, self.hero_group2, self.hero1.bullets, self.hero2.bullets, self.enemy_group, self.global_enemy_bullets]: 
            ...
            # 绘制和更新所有精灵组
            for group in [self.back_group, self.hero_group1, self.hero_group2, self.hero1.bullets, self.hero2.bullets, self.enemy_group]:
                group.draw(self.screen)
                group.update()
            # 绘制和更新全局敌人子弹组
    ...
    def show_life(self):
        ...
        text2 = 'SCORE1 :' + str(self.score1)
        text3 = 'LIFE2 :' + str(self.life2)
        text4 = 'SCORE2 :' + str(self.score2)
        try:
